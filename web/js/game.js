...
window.addEventListener("load", function () {
  ...
  //   )
  // ) {
  //   Crafty.init(400, 800, document.getElementById("game"));
  // } else {
  Crafty.init(1344, 720, document.getElementById("game"));
  // }
  Crafty.paths({ audio: "assets/audio/", images: "assets/images/" });
  var assets = {
    audio: {
      bgCafeCremiux:
        "STREAMING-a-little-bit-of-fun-jonny-boyle-main-version-02-33-1.mp3",
  ...
  Crafty.load(assets, function () {
    ...
    drawTree(4, 3, 2);
    drawBoat(19, 10);
    var startDialog = new bootstrap.Modal(
      document.getElementById("startDialog"),
      {}
    );
    let startDlgBtn = document.getElementById("startDlgBtn");
    startDlgBtn.addEventListener(
      "click",
      function () {
        startDialog.hide();
        startGame();
